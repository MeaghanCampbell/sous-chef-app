    ...
    return (
        <nav className={`rich-black-bg blush min-h-screen ${open ? 'open' : 'closed'}`}>
            <div className="mt-4 fixed">
                ...
                <div>
                    <Link href="/dashboard" className="nav-title font-medium px-5 transition py-4 flex items-center">
                    ...
                    <Link href="/dashboard/my-week" className="nav-title font-medium px-5 transition py-4 flex items-center">
                    ...
                    <Link href="/dashboard/grocery-list" className="nav-title font-medium px-5 transition py-4 flex items-center">
